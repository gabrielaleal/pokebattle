...
- [ ] Add an email address to the `ADMINS` settings variable in `pokebattle/pokebattle/settings/base.py`
- [ ] Change the `SERVER_EMAIL` to the email address used to send e-mails in `pokebattle/pokebattle/settings/production.py`
